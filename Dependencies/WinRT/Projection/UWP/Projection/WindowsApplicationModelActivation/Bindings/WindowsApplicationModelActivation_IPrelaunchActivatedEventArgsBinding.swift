...
public enum WindowsApplicationModelActivation_IPrelaunchActivatedEventArgsBinding: WindowsRuntime.InterfaceBinding {
    public typealias SwiftObject = WindowsApplicationModelActivation_IPrelaunchActivatedEventArgs
    public typealias ABIStruct = SWRT_WindowsApplicationModelActivation_IPrelaunchActivatedEventArgs

    public static let typeName = "Windows.ApplicationModel.Activation.IPrelaunchActivatedEventArgs"
    ...
    private final class Import: WinRTImport<WindowsApplicationModelActivation_IPrelaunchActivatedEventArgsBinding>, WindowsApplicationModelActivation_IPrelaunchActivatedEventArgsProtocol {
        public var prelaunchActivated: Swift.Bool {
            get throws {
                try _interop.get_PrelaunchActivated()
            }
        }
    ...
    private static var virtualTable = SWRT_WindowsApplicationModelActivation_IPrelaunchActivatedEventArgs_VirtualTable(
        ...
        get_PrelaunchActivated: { this, _result in _implement(this) { this in
            guard let _result else { throw COM.COMError.pointer }
            _result.pointee = try this.prelaunchActivated
        } }
    )
}