...
public final class WindowsUIComposition_VisualUnorderedCollection: WindowsUIComposition_CompositionObject, WindowsFoundationCollections_IIterableProtocol, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IVisualUnorderedCollection>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIVisualUnorderedCollection: COM.COMReference<SWRT_WindowsUIComposition_IVisualUnorderedCollection>.Optional = .none

    internal var _ivisualUnorderedCollection: COM.COMInterop<SWRT_WindowsUIComposition_IVisualUnorderedCollection> {
        get throws {
            try _lazyIVisualUnorderedCollection.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IVisualUnorderedCollection.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.VisualUnorderedCollection")
            }
        }
    }
}