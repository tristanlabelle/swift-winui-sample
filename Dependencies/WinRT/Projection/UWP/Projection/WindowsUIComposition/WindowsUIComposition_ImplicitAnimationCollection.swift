...
public final class WindowsUIComposition_ImplicitAnimationCollection: WindowsUIComposition_CompositionObject, WindowsFoundationCollections_IIterableProtocol, WindowsFoundationCollections_IMapProtocol, @unchecked Sendable {
    ...
    // MARK: Windows.Foundation.Collections.IMap<String, Windows.UI.Composition.ICompositionAnimationBase> members
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IImplicitAnimationCollection>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIImplicitAnimationCollection: COM.COMReference<SWRT_WindowsUIComposition_IImplicitAnimationCollection>.Optional = .none

    internal var _iimplicitAnimationCollection: COM.COMInterop<SWRT_WindowsUIComposition_IImplicitAnimationCollection> {
        get throws {
            try _lazyIImplicitAnimationCollection.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IImplicitAnimationCollection.self)).cast()
            }
        }
    }
    ...
    private var _lazyIMap: COM.COMReference<SWRT_WindowsFoundationCollections_IMap_String_WindowsUIComposition_ICompositionAnimationBase>.Optional = .none

    internal var _imap: COM.COMInterop<SWRT_WindowsFoundationCollections_IMap_String_WindowsUIComposition_ICompositionAnimationBase> {
        get throws {
            try _lazyIMap.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsFoundationCollections_IMap_String_WindowsUIComposition_ICompositionAnimationBase.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.ImplicitAnimationCollection")
            }
        }
    }
}