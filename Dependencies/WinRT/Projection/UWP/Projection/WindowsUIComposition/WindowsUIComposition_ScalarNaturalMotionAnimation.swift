...
open class WindowsUIComposition_ScalarNaturalMotionAnimation: WindowsUIComposition_NaturalMotionAnimation, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IScalarNaturalMotionAnimation>) {
    ...
    private var _lazyIScalarNaturalMotionAnimation: COM.COMReference<SWRT_WindowsUIComposition_IScalarNaturalMotionAnimation>.Optional = .none

    internal var _iscalarNaturalMotionAnimation: COM.COMInterop<SWRT_WindowsUIComposition_IScalarNaturalMotionAnimation> {
        get throws {
            try _lazyIScalarNaturalMotionAnimation.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_WindowsUIComposition_IScalarNaturalMotionAnimation.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.ScalarNaturalMotionAnimation")
            }
        }
    }

    private static var _lazyIScalarNaturalMotionAnimationFactory: COM.COMReference<SWRT_WindowsUIComposition_IScalarNaturalMotionAnimationFactory>.Optional = .none

    internal static var _iscalarNaturalMotionAnimationFactory: COM.COMInterop<SWRT_WindowsUIComposition_IScalarNaturalMotionAnimationFactory> {
        get throws {
            try _lazyIScalarNaturalMotionAnimationFactory.lazyInitInterop {
                try _iactivationFactory.queryInterface(uuidof(SWRT_WindowsUIComposition_IScalarNaturalMotionAnimationFactory.self)).cast()
            }
        }
    }
}