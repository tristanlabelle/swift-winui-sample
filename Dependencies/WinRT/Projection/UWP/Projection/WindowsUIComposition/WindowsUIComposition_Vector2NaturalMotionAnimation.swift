...
open class WindowsUIComposition_Vector2NaturalMotionAnimation: WindowsUIComposition_NaturalMotionAnimation, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IVector2NaturalMotionAnimation>) {
    ...
    private var _lazyIVector2NaturalMotionAnimation: COM.COMReference<SWRT_WindowsUIComposition_IVector2NaturalMotionAnimation>.Optional = .none

    internal var _ivector2NaturalMotionAnimation: COM.COMInterop<SWRT_WindowsUIComposition_IVector2NaturalMotionAnimation> {
        get throws {
            try _lazyIVector2NaturalMotionAnimation.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_WindowsUIComposition_IVector2NaturalMotionAnimation.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.Vector2NaturalMotionAnimation")
            }
        }
    }

    private static var _lazyIVector2NaturalMotionAnimationFactory: COM.COMReference<SWRT_WindowsUIComposition_IVector2NaturalMotionAnimationFactory>.Optional = .none

    internal static var _ivector2NaturalMotionAnimationFactory: COM.COMInterop<SWRT_WindowsUIComposition_IVector2NaturalMotionAnimationFactory> {
        get throws {
            try _lazyIVector2NaturalMotionAnimationFactory.lazyInitInterop {
                try _iactivationFactory.queryInterface(uuidof(SWRT_WindowsUIComposition_IVector2NaturalMotionAnimationFactory.self)).cast()
            }
        }
    }
}