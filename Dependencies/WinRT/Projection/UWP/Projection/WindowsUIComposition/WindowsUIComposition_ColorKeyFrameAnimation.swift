...
public final class WindowsUIComposition_ColorKeyFrameAnimation: WindowsUIComposition_KeyFrameAnimation, @unchecked Sendable {
    /// Inserts a key frame.
    ...
    /// The color space the color interpolation should run through.
    public var interpolationColorSpace_: WindowsUIComposition_CompositionColorSpace {
        get {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IColorKeyFrameAnimation>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIColorKeyFrameAnimation: COM.COMReference<SWRT_WindowsUIComposition_IColorKeyFrameAnimation>.Optional = .none

    internal var _icolorKeyFrameAnimation: COM.COMInterop<SWRT_WindowsUIComposition_IColorKeyFrameAnimation> {
        get throws {
            try _lazyIColorKeyFrameAnimation.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IColorKeyFrameAnimation.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.ColorKeyFrameAnimation")
            }
        }
    }
}