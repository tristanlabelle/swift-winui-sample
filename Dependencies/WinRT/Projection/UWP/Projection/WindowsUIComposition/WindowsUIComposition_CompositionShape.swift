...
open class WindowsUIComposition_CompositionShape: WindowsUIComposition_CompositionObject, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_ICompositionShape>) {
    ...
    private var _lazyICompositionShape: COM.COMReference<SWRT_WindowsUIComposition_ICompositionShape>.Optional = .none

    internal var _icompositionShape: COM.COMInterop<SWRT_WindowsUIComposition_ICompositionShape> {
        get throws {
            try _lazyICompositionShape.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_WindowsUIComposition_ICompositionShape.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.CompositionShape")
            }
        }
    }

    private static var _lazyICompositionShapeFactory: COM.COMReference<SWRT_WindowsUIComposition_ICompositionShapeFactory>.Optional = .none

    internal static var _icompositionShapeFactory: COM.COMInterop<SWRT_WindowsUIComposition_ICompositionShapeFactory> {
        get throws {
            try _lazyICompositionShapeFactory.lazyInitInterop {
                try _iactivationFactory.queryInterface(uuidof(SWRT_WindowsUIComposition_ICompositionShapeFactory.self)).cast()
            }
        }
    }
}