...
public final class WindowsUIComposition_CompositionColorGradientStopCollection: WindowsRuntime.WinRTImport<WindowsUIComposition_CompositionColorGradientStopCollectionBinding>, WindowsFoundationCollections_IIterableProtocol, WindowsFoundationCollections_IVectorProtocol, @unchecked Sendable {
    ...
    // MARK: Windows.Foundation.Collections.IVector<Windows.UI.Composition.CompositionColorGradientStop> members
    ...
    public required init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_ICompositionColorGradientStopCollection>) {
    ...
    private var _lazyIVector: COM.COMReference<SWRT_WindowsFoundationCollections_IVector_WindowsUIComposition_CompositionColorGradientStop>.Optional = .none

    internal var _ivector: COM.COMInterop<SWRT_WindowsFoundationCollections_IVector_WindowsUIComposition_CompositionColorGradientStop> {
        get throws {
            try _lazyIVector.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsFoundationCollections_IVector_WindowsUIComposition_CompositionColorGradientStop.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.CompositionColorGradientStopCollection")
            }
        }
    }
}