...
public final class WindowsUIComposition_DropShadow: WindowsUIComposition_CompositionShadow, @unchecked Sendable {
    ...
    /// Used to define the shadow masking policy to be used for the shadow.
    public var sourcePolicy_: WindowsUIComposition_CompositionDropShadowSourcePolicy {
        get {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IDropShadow>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIDropShadow: COM.COMReference<SWRT_WindowsUIComposition_IDropShadow>.Optional = .none

    internal var _idropShadow: COM.COMInterop<SWRT_WindowsUIComposition_IDropShadow> {
        get throws {
            try _lazyIDropShadow.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IDropShadow.self)).cast()
            }
        }
    }

    private var _lazyIDropShadow2: COM.COMReference<SWRT_WindowsUIComposition_IDropShadow2>.Optional = .none

    internal var _idropShadow2: COM.COMInterop<SWRT_WindowsUIComposition_IDropShadow2> {
        get throws {
            try _lazyIDropShadow2.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IDropShadow2.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.DropShadow")
            }
        }
    }
}