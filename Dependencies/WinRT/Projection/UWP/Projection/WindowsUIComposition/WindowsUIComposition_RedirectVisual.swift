...
public final class WindowsUIComposition_RedirectVisual: WindowsUIComposition_ContainerVisual, @unchecked Sendable {
    ...
    public var source_: WindowsUIComposition_Visual! {
        get {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_IRedirectVisual>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIRedirectVisual: COM.COMReference<SWRT_WindowsUIComposition_IRedirectVisual>.Optional = .none

    internal var _iredirectVisual: COM.COMInterop<SWRT_WindowsUIComposition_IRedirectVisual> {
        get throws {
            try _lazyIRedirectVisual.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_IRedirectVisual.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.RedirectVisual")
            }
        }
    }
}