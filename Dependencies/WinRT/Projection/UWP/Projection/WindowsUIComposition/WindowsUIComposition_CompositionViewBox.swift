...
public final class WindowsUIComposition_CompositionViewBox: WindowsUIComposition_CompositionObject, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsUIComposition_ICompositionViewBox>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionViewBox: COM.COMReference<SWRT_WindowsUIComposition_ICompositionViewBox>.Optional = .none

    internal var _icompositionViewBox: COM.COMInterop<SWRT_WindowsUIComposition_ICompositionViewBox> {
        get throws {
            try _lazyICompositionViewBox.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsUIComposition_ICompositionViewBox.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Windows.UI.Composition.CompositionViewBox")
            }
        }
    }
}