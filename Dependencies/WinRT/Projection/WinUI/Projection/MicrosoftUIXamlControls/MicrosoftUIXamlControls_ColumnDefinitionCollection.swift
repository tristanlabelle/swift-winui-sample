...
public final class MicrosoftUIXamlControls_ColumnDefinitionCollection: WindowsRuntime.WinRTImport<MicrosoftUIXamlControls_ColumnDefinitionCollectionBinding>, WindowsFoundationCollections_IVectorProtocol, WindowsFoundationCollections_IIterableProtocol, @unchecked Sendable {
    public typealias T = MicrosoftUIXamlControls_ColumnDefinition?

    // MARK: Windows.Foundation.Collections.IVector<Microsoft.UI.Xaml.Controls.ColumnDefinition> members
    ...
    public required init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIXamlControls_ColumnDefinition>) {
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Xaml.Controls.ColumnDefinitionCollection")
            }
        }
    }
}