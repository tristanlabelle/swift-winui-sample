...
public final class MicrosoftUIXamlMediaAnimation_TransitionCollection: WindowsRuntime.WinRTImport<MicrosoftUIXamlMediaAnimation_TransitionCollectionBinding>, WindowsFoundationCollections_IVectorProtocol, WindowsFoundationCollections_IIterableProtocol, @unchecked Sendable {
    public typealias T = MicrosoftUIXamlMediaAnimation_Transition?

    /// Initializes a new instance of the TransitionCollection class.
    public init() throws {
        let _instance = COM.COMReference(transferringRef: try Self._iactivationFactory.activateInstance(binding: MicrosoftUIXamlMediaAnimation_TransitionCollectionBinding.self))
        super.init(_wrapping: consume _instance)
    }

    // MARK: Windows.Foundation.Collections.IVector<Microsoft.UI.Xaml.Media.Animation.Transition> members
    ...
    public required init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIXamlMediaAnimation_Transition>) {
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Xaml.Media.Animation.TransitionCollection")
            }
        }
    }
}