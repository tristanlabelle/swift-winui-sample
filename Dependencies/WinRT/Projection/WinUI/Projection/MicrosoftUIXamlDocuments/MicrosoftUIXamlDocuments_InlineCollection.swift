...
public final class MicrosoftUIXamlDocuments_InlineCollection: WindowsRuntime.WinRTImport<MicrosoftUIXamlDocuments_InlineCollectionBinding>, WindowsFoundationCollections_IVectorProtocol, WindowsFoundationCollections_IIterableProtocol, @unchecked Sendable {
    public typealias T = MicrosoftUIXamlDocuments_Inline?

    // MARK: Windows.Foundation.Collections.IVector<Microsoft.UI.Xaml.Documents.Inline> members
    ...
    public required init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIXamlDocuments_Inline>) {
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Xaml.Documents.InlineCollection")
            }
        }
    }
}