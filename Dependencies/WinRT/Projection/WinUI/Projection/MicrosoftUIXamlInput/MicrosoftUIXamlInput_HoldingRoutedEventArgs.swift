...
public final class MicrosoftUIXamlInput_HoldingRoutedEventArgs: MicrosoftUIXaml_RoutedEventArgs, @unchecked Sendable {
    /// Initializes a new instance of the HoldingRoutedEventArgs class.
    public override init() throws {
        let _instance = COM.COMReference(transferringRef: try Self._iactivationFactory.activateInstance(binding: MicrosoftUIXamlInput_HoldingRoutedEventArgsBinding.self))
    ...
    public func getPosition(_ relativeTo: MicrosoftUIXaml_UIElement?) throws -> WindowsFoundation_Point {
        try _iholdingRoutedEventArgs.getPosition(relativeTo)
    }

    /// true to mark the routed event handled. false to leave the routed event unhandled, which permits the event to potentially route further and be acted on by other handlers. The default is false.
    public var handled: Swift.Bool {
        get throws {
            try _iholdingRoutedEventArgs.get_Handled()
        }
    }
    ...
    public func handled(_ value: Swift.Bool) throws {
        try _iholdingRoutedEventArgs.put_Handled(value)
    }
    ...
    public var holdingState: MicrosoftUIInput_HoldingState {
        get throws {
            try _iholdingRoutedEventArgs.get_HoldingState()
        }
    }

    /// Gets the underlying HoldingState for the interaction.
    public var holdingState_: MicrosoftUIInput_HoldingState {
        try! self.holdingState
    }

    /// The PointerDeviceType for this event occurrence.
    public var pointerDeviceType: MicrosoftUIInput_PointerDeviceType {
        get throws {
            try _iholdingRoutedEventArgs.get_PointerDeviceType()
        }
    }
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIXamlInput_IHoldingRoutedEventArgs>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIHoldingRoutedEventArgs: COM.COMReference<SWRT_MicrosoftUIXamlInput_IHoldingRoutedEventArgs>.Optional = .none

    internal var _iholdingRoutedEventArgs: COM.COMInterop<SWRT_MicrosoftUIXamlInput_IHoldingRoutedEventArgs> {
        get throws {
            try _lazyIHoldingRoutedEventArgs.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIXamlInput_IHoldingRoutedEventArgs.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Xaml.Input.HoldingRoutedEventArgs")
            }
        }
    }
}