...
public final class MicrosoftUIComposition_CompositionShapeCollection: MicrosoftUIComposition_CompositionObject, WindowsFoundationCollections_IVectorProtocol, WindowsFoundationCollections_IIterableProtocol, @unchecked Sendable {
    public typealias T = MicrosoftUIComposition_CompositionShape?

    // MARK: Windows.Foundation.Collections.IVector<Microsoft.UI.Composition.CompositionShape> members
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIComposition_CompositionShape>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIVector: COM.COMReference<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIComposition_CompositionShape>.Optional = .none

    internal var _ivector: COM.COMInterop<SWRT_WindowsFoundationCollections_IVector_MicrosoftUIComposition_CompositionShape> {
        get throws {
            try _lazyIVector.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_WindowsFoundationCollections_IVector_MicrosoftUIComposition_CompositionShape.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionShapeCollection")
            }
        }
    }
}