...
public final class MicrosoftUIComposition_AnimationController: MicrosoftUIComposition_CompositionObject, @unchecked Sendable {
    ...
    public var progressBehavior: MicrosoftUIComposition_AnimationControllerProgressBehavior {
        get throws {
    ...
    public func progressBehavior(_ value: MicrosoftUIComposition_AnimationControllerProgressBehavior) throws {
        try _ianimationController.put_ProgressBehavior(value)
    }

    /// Gets or sets a value that indicates how progress is determined.
    public var progressBehavior_: MicrosoftUIComposition_AnimationControllerProgressBehavior {
        get {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_IAnimationController>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIAnimationController: COM.COMReference<SWRT_MicrosoftUIComposition_IAnimationController>.Optional = .none

    internal var _ianimationController: COM.COMInterop<SWRT_MicrosoftUIComposition_IAnimationController> {
        get throws {
            try _lazyIAnimationController.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_IAnimationController.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.AnimationController")
            }
        }
    }

    private static var _lazyIAnimationControllerStatics: COM.COMReference<SWRT_MicrosoftUIComposition_IAnimationControllerStatics>.Optional = .none

    internal static var _ianimationControllerStatics: COM.COMInterop<SWRT_MicrosoftUIComposition_IAnimationControllerStatics> {
        get throws {
            try _lazyIAnimationControllerStatics.lazyInitInterop {
                try _iactivationFactory.queryInterface(uuidof(SWRT_MicrosoftUIComposition_IAnimationControllerStatics.self)).cast()
            }
        }
    }
}