...
public final class MicrosoftUIComposition_CompositionProjectedShadow: MicrosoftUIComposition_CompositionObject, @unchecked Sendable {
    ...
    public var casters: MicrosoftUIComposition_CompositionProjectedShadowCasterCollection {
        get throws {
    ...
    public var casters_: MicrosoftUIComposition_CompositionProjectedShadowCasterCollection! {
        try! NullResult.catch(self.casters)
    }

    /// The composition light that determines the direction the shadow is cast.
    public var lightSource: MicrosoftUIComposition_CompositionLight {
        get throws {
    ...
    public func lightSource(_ value: MicrosoftUIComposition_CompositionLight?) throws {
    ...
    public var lightSource_: MicrosoftUIComposition_CompositionLight! {
        get {
    ...
    public var receivers: MicrosoftUIComposition_CompositionProjectedShadowReceiverUnorderedCollection {
        get throws {
    ...
    public var receivers_: MicrosoftUIComposition_CompositionProjectedShadowReceiverUnorderedCollection! {
        try! NullResult.catch(self.receivers)
    }

    // MARK: Implementation details

    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionProjectedShadow>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionProjectedShadow: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionProjectedShadow>.Optional = .none

    internal var _icompositionProjectedShadow: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionProjectedShadow> {
        get throws {
            try _lazyICompositionProjectedShadow.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionProjectedShadow.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionProjectedShadow")
            }
        }
    }
}