...
public final class MicrosoftUIComposition_CompositionNineGridBrush: MicrosoftUIComposition_CompositionBrush, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionNineGridBrush>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionNineGridBrush: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionNineGridBrush>.Optional = .none

    internal var _icompositionNineGridBrush: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionNineGridBrush> {
        get throws {
            try _lazyICompositionNineGridBrush.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionNineGridBrush.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionNineGridBrush")
            }
        }
    }
}