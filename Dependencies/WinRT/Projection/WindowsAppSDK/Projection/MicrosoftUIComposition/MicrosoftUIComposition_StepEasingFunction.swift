...
public final class MicrosoftUIComposition_StepEasingFunction: MicrosoftUIComposition_CompositionEasingFunction, @unchecked Sendable {
    /// The step to end at.
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_IStepEasingFunction>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIStepEasingFunction: COM.COMReference<SWRT_MicrosoftUIComposition_IStepEasingFunction>.Optional = .none

    internal var _istepEasingFunction: COM.COMInterop<SWRT_MicrosoftUIComposition_IStepEasingFunction> {
        get throws {
            try _lazyIStepEasingFunction.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_IStepEasingFunction.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.StepEasingFunction")
            }
        }
    }
}