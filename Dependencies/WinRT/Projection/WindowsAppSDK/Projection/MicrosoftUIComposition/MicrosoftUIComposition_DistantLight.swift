...
public final class MicrosoftUIComposition_DistantLight: MicrosoftUIComposition_CompositionLight, @unchecked Sendable {
    ...
    ///     CoordinateSpace
    ///    is not set, the DistantLight will not render.
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_IDistantLight>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyIDistantLight: COM.COMReference<SWRT_MicrosoftUIComposition_IDistantLight>.Optional = .none

    internal var _idistantLight: COM.COMInterop<SWRT_MicrosoftUIComposition_IDistantLight> {
        get throws {
            try _lazyIDistantLight.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_IDistantLight.self)).cast()
            }
        }
    }

    private var _lazyIDistantLight2: COM.COMReference<SWRT_MicrosoftUIComposition_IDistantLight2>.Optional = .none

    internal var _idistantLight2: COM.COMInterop<SWRT_MicrosoftUIComposition_IDistantLight2> {
        get throws {
            try _lazyIDistantLight2.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_IDistantLight2.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.DistantLight")
            }
        }
    }
}