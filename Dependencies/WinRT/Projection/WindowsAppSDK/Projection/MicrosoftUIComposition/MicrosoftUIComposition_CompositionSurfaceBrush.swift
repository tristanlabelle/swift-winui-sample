...
public final class MicrosoftUIComposition_CompositionSurfaceBrush: MicrosoftUIComposition_CompositionBrush, @unchecked Sendable {
    ...
    public var bitmapInterpolationMode: MicrosoftUIComposition_CompositionBitmapInterpolationMode {
        get throws {
    ...
    public func bitmapInterpolationMode(_ value: MicrosoftUIComposition_CompositionBitmapInterpolationMode) throws {
        try _icompositionSurfaceBrush.put_BitmapInterpolationMode(value)
    }

    /// Specifies the algorithm used for interpolating pixels from ICompositionSurface when they do not form a one-to-one mapping to pixels on SpriteVisual (as can happen under stretch, scale, rotation, and other transformations).
    public var bitmapInterpolationMode_: MicrosoftUIComposition_CompositionBitmapInterpolationMode {
        get {
    ...
    /// - Parameter newValue: The default value is 0.5f.
    ...
    public var surface: MicrosoftUIComposition_ICompositionSurface {
        get throws {
    ...
    public func surface(_ value: MicrosoftUIComposition_ICompositionSurface?) throws {
        try _icompositionSurfaceBrush.put_Surface(value)
    }

    /// The ICompositionSurface associated with the CompositionSurfaceBrush.
    public var surface_: MicrosoftUIComposition_ICompositionSurface! {
        get {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionSurfaceBrush: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush>.Optional = .none

    internal var _icompositionSurfaceBrush: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush> {
        get throws {
            try _lazyICompositionSurfaceBrush.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush.self)).cast()
            }
        }
    }

    private var _lazyICompositionSurfaceBrush2: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush2>.Optional = .none

    internal var _icompositionSurfaceBrush2: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush2> {
        get throws {
            try _lazyICompositionSurfaceBrush2.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush2.self)).cast()
            }
        }
    }

    private var _lazyICompositionSurfaceBrush3: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush3>.Optional = .none

    internal var _icompositionSurfaceBrush3: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush3> {
        get throws {
            try _lazyICompositionSurfaceBrush3.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionSurfaceBrush3.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionSurfaceBrush")
            }
        }
    }
}