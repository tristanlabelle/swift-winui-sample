...
public final class MicrosoftUIComposition_CompositionCommitBatch: MicrosoftUIComposition_CompositionObject, @unchecked Sendable {
    /// Event that is triggered when all objects in a CompositionCommitBatch have completed.
    @discardableResult
    public func completed(adding handler: WindowsFoundation_TypedEventHandler<WindowsRuntime.IInspectable?, MicrosoftUIComposition_CompositionBatchCompletedEventArgs?>?) throws -> WindowsRuntime.EventRegistration {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionCommitBatch>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionCommitBatch: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionCommitBatch>.Optional = .none

    internal var _icompositionCommitBatch: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionCommitBatch> {
        get throws {
            try _lazyICompositionCommitBatch.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionCommitBatch.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionCommitBatch")
            }
        }
    }
}