...
public final class MicrosoftUIComposition_CompositionScopedBatch: MicrosoftUIComposition_CompositionObject, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionScopedBatch>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyICompositionScopedBatch: COM.COMReference<SWRT_MicrosoftUIComposition_ICompositionScopedBatch>.Optional = .none

    internal var _icompositionScopedBatch: COM.COMInterop<SWRT_MicrosoftUIComposition_ICompositionScopedBatch> {
        get throws {
            try _lazyICompositionScopedBatch.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ICompositionScopedBatch.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.CompositionScopedBatch")
            }
        }
    }
}