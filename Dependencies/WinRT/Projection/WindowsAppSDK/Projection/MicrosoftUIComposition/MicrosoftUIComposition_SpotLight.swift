...
public final class MicrosoftUIComposition_SpotLight: MicrosoftUIComposition_CompositionLight, @unchecked Sendable {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_ISpotLight>) {
        super.init(_wrapping: inner.cast()) // Transitively casts down to IInspectable
    }

    private var _lazyISpotLight: COM.COMReference<SWRT_MicrosoftUIComposition_ISpotLight>.Optional = .none

    internal var _ispotLight: COM.COMInterop<SWRT_MicrosoftUIComposition_ISpotLight> {
        get throws {
            try _lazyISpotLight.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ISpotLight.self)).cast()
            }
        }
    }

    private var _lazyISpotLight2: COM.COMReference<SWRT_MicrosoftUIComposition_ISpotLight2>.Optional = .none

    internal var _ispotLight2: COM.COMInterop<SWRT_MicrosoftUIComposition_ISpotLight2> {
        get throws {
            try _lazyISpotLight2.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ISpotLight2.self)).cast()
            }
        }
    }

    private var _lazyISpotLight3: COM.COMReference<SWRT_MicrosoftUIComposition_ISpotLight3>.Optional = .none

    internal var _ispotLight3: COM.COMInterop<SWRT_MicrosoftUIComposition_ISpotLight3> {
        get throws {
            try _lazyISpotLight3.lazyInitInterop {
                try _queryInterface(uuidof(SWRT_MicrosoftUIComposition_ISpotLight3.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.SpotLight")
            }
        }
    }
}