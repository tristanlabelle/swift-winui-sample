...
open class MicrosoftUIComposition_KeyFrameAnimation: MicrosoftUIComposition_CompositionAnimation, @unchecked Sendable {
    ...
    public func insertExpressionKeyFrame(_ normalizedProgressKey: Swift.Float, _ value: Swift.String, _ easingFunction: MicrosoftUIComposition_CompositionEasingFunction?) throws {
    ...
    public var iterationBehavior: MicrosoftUIComposition_AnimationIterationBehavior {
        get throws {
    ...
    public func iterationBehavior(_ value: MicrosoftUIComposition_AnimationIterationBehavior) throws {
        try _ikeyFrameAnimation.put_IterationBehavior(value)
    }

    /// The iteration behavior for the key frame animation.
    public var iterationBehavior_: MicrosoftUIComposition_AnimationIterationBehavior {
        get {
    ...
    public var direction: MicrosoftUIComposition_AnimationDirection {
        get throws {
    ...
    /// The 
    ///     Direction
    ///    property allows you to drive your animation from start to end or end to start or alternate between start and end or end to start if animation has an IterationCount greater than one. This gives an easy way for customizing animation definitions.
    /// - Parameter newValue: The direction the animation is playing.
    public func direction(_ value: MicrosoftUIComposition_AnimationDirection) throws {
    ...
    ///     Direction
    ///    property allows you to drive your animation from start to end or end to start or alternate between start and end or end to start if animation has an IterationCount greater than one. This gives an easy way for customizing animation definitions.
    public var direction_: MicrosoftUIComposition_AnimationDirection {
        get {
            try! self.direction
        }
        set {
    ...
    public init(_wrapping inner: consuming COM.COMReference<SWRT_MicrosoftUIComposition_IKeyFrameAnimation>) {
    ...
    private var _lazyIKeyFrameAnimation: COM.COMReference<SWRT_MicrosoftUIComposition_IKeyFrameAnimation>.Optional = .none

    internal var _ikeyFrameAnimation: COM.COMInterop<SWRT_MicrosoftUIComposition_IKeyFrameAnimation> {
        get throws {
            try _lazyIKeyFrameAnimation.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_MicrosoftUIComposition_IKeyFrameAnimation.self)).cast()
            }
        }
    }

    private var _lazyIKeyFrameAnimation2: COM.COMReference<SWRT_MicrosoftUIComposition_IKeyFrameAnimation2>.Optional = .none

    internal var _ikeyFrameAnimation2: COM.COMInterop<SWRT_MicrosoftUIComposition_IKeyFrameAnimation2> {
        get throws {
            try _lazyIKeyFrameAnimation2.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_MicrosoftUIComposition_IKeyFrameAnimation2.self)).cast()
            }
        }
    }

    private var _lazyIKeyFrameAnimation3: COM.COMReference<SWRT_MicrosoftUIComposition_IKeyFrameAnimation3>.Optional = .none

    internal var _ikeyFrameAnimation3: COM.COMInterop<SWRT_MicrosoftUIComposition_IKeyFrameAnimation3> {
        get throws {
            try _lazyIKeyFrameAnimation3.lazyInitInterop {
                try _queryInnerInterface(uuidof(SWRT_MicrosoftUIComposition_IKeyFrameAnimation3.self)).cast()
            }
        }
    }
    ...
    private static var _iactivationFactory: COM.COMInterop<SWRT_IActivationFactory> {
        get throws {
            try _lazyIActivationFactory.lazyInitInterop {
                try WindowsRuntime.activationFactoryResolver.resolve(runtimeClass: "Microsoft.UI.Composition.KeyFrameAnimation")
            }
        }
    }

    private static var _lazyIKeyFrameAnimationFactory: COM.COMReference<SWRT_MicrosoftUIComposition_IKeyFrameAnimationFactory>.Optional = .none

    internal static var _ikeyFrameAnimationFactory: COM.COMInterop<SWRT_MicrosoftUIComposition_IKeyFrameAnimationFactory> {
        get throws {
            try _lazyIKeyFrameAnimationFactory.lazyInitInterop {
                try _iactivationFactory.queryInterface(uuidof(SWRT_MicrosoftUIComposition_IKeyFrameAnimationFactory.self)).cast()
            }
        }
    }
}